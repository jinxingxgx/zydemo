...
public class FaceSetUtil {
    public static Response searchFaceset(Context context, String API_KEY, String API_Secret, File imageFile, String courseId) {
        OkHttpClient client = new OkHttpClient();
        RequestBody requestBody = postBodySearchFaceSet(context, API_KEY, API_Secret, imageFile, courseId);
    ...
    protected static RequestBody postBodySearchFaceSet(Context context, String API_KEY, String API_Secret, File file, String courseId) {
        // 设置请求体
        ...
        //  String outerId = SPUtils.getInstance().getString("username", "");
        builder.addFormDataPart("outer_id", courseId);
