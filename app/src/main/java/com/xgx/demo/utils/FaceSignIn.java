...
public class FaceSignIn {
    ...
    public String toString() {
        return "FaceSignIn{" + "time_used=" + time_used + ", thresholds3=" + thresholds3 + ", thresholds4=" + thresholds4 + ", thresholds5=" + thresholds5 + ", confidence=" + confidence + ", face_token='" + face_token + '\'' + '}';
    }
}
